...
declare const useSuggestions: ({ allowEmpty, choices, emptyText, emptyValue, limitChoicesToValue, matchSuggestion, optionText, optionValue, selectedItem, suggestionLimit, translateChoice, }: Options) => {
 ...
 */
export declare const getSuggestionsFactory: ({ choices, allowEmpty, emptyText, emptyValue, optionText, optionValue, getChoiceText, getChoiceValue, limitChoicesToValue, matchSuggestion, selectedItem, suggestionLimit, }: {
    choices?: any[];
    allowEmpty: any;
    emptyText: any;
    emptyValue: any;
