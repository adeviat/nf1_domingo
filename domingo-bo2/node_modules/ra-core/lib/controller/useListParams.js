...
var useListParams = function (_a) {
    ...
    var params = react_redux_1.useSelector(function (reduxState) { return reduxState.admin.resources[resource].list; }, react_redux_1.shallowEqual).params;
    ...
    var changeParams = react_1.useCallback(function (action) {
        ...
        history.push({
            search: "?" + query_string_1.stringify(__assign({}, newParams, { filter: JSON.stringify(newParams.filter) })),
        });
...
exports.getQuery = function (_a) {
    ...
    return __assign({}, query, { page: exports.getNumberOrDefault(query.page, 1), perPage: exports.getNumberOrDefault(query.perPage, 10) });
};
