 ...
 * };
 */
declare const useUpdate: (resource: string, id: import("react").ReactText, data?: any, previousData?: any, options?: any) => [(query: Partial<import("./useMutation").Mutation>, options?: Partial<import("./useMutation").MutationOptions>) => void, {
    data?: any;
    total?: number;
    error?: any;
    loading: boolean;
