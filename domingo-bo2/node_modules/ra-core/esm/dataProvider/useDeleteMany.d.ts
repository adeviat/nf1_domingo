 ...
 * };
 */
declare const useDeleteMany: (resource: string, ids: [import("react").ReactText], options?: any) => [(query: Partial<import("./useMutation").Mutation>, options?: Partial<import("./useMutation").MutationOptions>) => void, {
    data?: any;
    total?: number;
    error?: any;
    loading: boolean;
