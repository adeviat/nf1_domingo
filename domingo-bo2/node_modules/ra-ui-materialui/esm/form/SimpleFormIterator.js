...
var SimpleFormIterator = /** @class */ (function (_super) {
    ...
    SimpleFormIterator.prototype.render = function () {
        ...
        return fields ? (React.createElement("ul", { className: classes.root },
            ...
            React.createElement(TransitionGroup, { component: null }, fields.map(function (member, index) { return (React.createElement(CSSTransition, { key: _this.ids[index], timeout: 500, classNames: "fade" },
