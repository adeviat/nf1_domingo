...
function PaginationActions(_a) {
    ...
    var renderPageNums = function () {
        return range().map(function (pageNum, index) {
            return pageNum === '.' ? (React.createElement("span", { key: "hyphen_" + index, className: classes.hellip }, "\u2026")) : (React.createElement(Button, { className: "page-number", color: pageNum === page + 1 ? 'default' : 'primary', key: pageNum, "data-page": pageNum - 1, onClick: gotoPage, size: "small" }, pageNum));
        });
    };
    ...
    return (React.createElement("div", { className: classes.actions },
        page > 0 && (React.createElement(Button, { color: "primary", key: "prev", onClick: prevPage, className: "previous-page", size: "small" },
            React.createElement(ChevronLeft, null),
            translate('ra.navigation.prev'))),
        renderPageNums(),
        page !== nbPages - 1 && (React.createElement(Button, { color: "primary", key: "next", onClick: nextPage, className: "next-page", size: "small" },
