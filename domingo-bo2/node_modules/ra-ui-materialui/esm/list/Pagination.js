...
var Pagination = function (_a) {
    ...
    if (total === 0) {
        return loading ? React.createElement(Toolbar, { variant: "dense" }) : React.createElement(PaginationLimit, null);
    }
    if (isSmall) {
    ...
    return (React.createElement(TablePagination, __assign({ count: total, rowsPerPage: perPage, page: page - 1, onChangePage: handlePageChange, onChangeRowsPerPage: handlePerPageChange, ActionsComponent: PaginationActions, component: "span", labelRowsPerPage: translate('ra.navigation.page_rows_per_page'), labelDisplayedRows: labelDisplayedRows, rowsPerPageOptions: rowsPerPageOptions }, sanitizeListRestProps(rest))));
};
