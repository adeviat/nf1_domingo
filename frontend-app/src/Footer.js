...
import './Footer.css';
import RestaurantList from "./ComponentList";
...
function Footer() {
  ...
  return (
      ...
      <div id = "footerarc" >
        < img id="footerarc1" src="https://res.cloudinary.com/glovoapp/image/fetch///https://glovoapp.com/images/svg/curve.svg" />
      </div>

        <div id="containerfooter">
          <div id="glovofooter">
            <img src="https://res.cloudinary.com/glovoapp/image/fetch///https://glovoapp.com/images/glovo-white.svg" />
          </div>
    ...
    <li className="footertext2">Facebook</li>
        ...
        <img className="iphone" src="https://res.cloudinary.com/glovoapp/image/fetch///https://glovoapp.com/images/app_store/download-button.svg" alt=""/>
        <img className="iphone" src="https://res.cloudinary.com/glovoapp/image/fetch///https://glovoapp.com/images/google_play/download-button.svg" alt=""/>
        </div>
        </div>
